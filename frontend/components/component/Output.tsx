...
export async function Output({ url }: { url: string }) {
  ...
  useEffect(() => {
    ...
    const fetchTranscript = async () => {
      console.log("cloudfare: ", `${process.env.NEXT_PUBLIC_CLOUDFLARE_WORKERS_URL}/v2`);
      ...
      console.log(ai_res.output.quiz)
      setLoading(false);
  ...
  return (
    <div className="w-full min-h-screen text-white">
      <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-5 lg:gap-8 lg:px-12 lg:pb-12 p-4">
        <div className="col-span-3 space-y-4">
          <div>
            ...
            {/* </BackgroundGradient> */}
            {
              ...
              loading ? <div className="flex space-x-4 text-slate-700 items-center mt-8 z-100 relative px-4 py-2 border border-blue-600 border-radius-10 rounded-xl">
        ...
        <div className="col-span-2 space-y-4 border-2 border-slate-400 rounded-lg p-5">
          <div>
            {/* <BackgroundGradient className="rounded-[22px] p-8  bg-zinc-900" containerClassName="mb-8"> */}
              <h2 className="text-2xl font-bold mb-2 text-slate-700">Video Summary</h2>
              {loading
                ?
                <div>
            ...
            {/* <BackgroundGradient className="rounded-[22px] p-8  bg-zinc-900"> */}
              {loading ?
                <div>
                  <h2 className="text-2xl font-bold mb-2 text-black">Quiz</h2>
                  <div className="space-y-2 mt-2 border-2 border-slate-500">
